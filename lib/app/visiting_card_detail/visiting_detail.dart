...
class VisitingDetails extends StatelessWidget {
  const VisitingDetails({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: MainAppBar(
          title: ConstantStrings.myadd1.tr,
          size: 20,
                ...
                child: Column(
                  ...
                  children: [
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                SizedBox(width: 16),
                                AppText(
                                  title: ConstantStrings.Published.tr,
                                  size: 12,
                                  color: AppColors.grey3,
                                ),
                                SizedBox(width: 16),
                                ...
                                SizedBox(width: 7),
                                AppText(
                                  title: ConstantStrings.daysago5.tr,
                                  size: 12,
                                  color: AppColors.grey3,
                                ),
                              ],
                    ...
                    AppButton(
                      ...
                      buttonName: ConstantStrings.share.tr,
                      onTap: () {},
                    ),
                    SizedBox(height: 20),
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            SizedBox(width: 14),
                            AppText(
                              title: ConstantStrings.sHAREWHATSAPP.tr,
                              color: AppColors.WhiteColor,
                              fontWeight: FontWeight.w600,
                              size: 12,
                            ),
                    ...
                    SizedBox(height: 20),
                    AppText(
                      title: ConstantStrings.invoicedetails.tr,
  ...
  return Stack(
    children: [
      ...
      Column(
        ...
        children: [
          AppText(
            title: ConstantStrings.analytics.tr,
            color: AppColors.itemNameClor,
            fontWeight: FontWeight.w600,
            size: 20,
          ),
