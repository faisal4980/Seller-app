...
import 'package:seller_app/app/catering_services/catering_service_controller.dart';
...
class Catering_Service extends StatelessWidget {
  Catering_Service({super.key});
  final CateringServiceController controller = CateringServiceController();
  @override
        ...
        title: Obx(() {
          return MainAppBar(
            ...
            imageSuffix: GestureDetector(
              onTap: () {
                Get.toNamed(Routes.cateringOrderRoute);
              },
              child: Image.asset(
                      ...
                      controller.selectValuetype.value == 'mysellers'
                          ? Column(
                              children: [
                                ...
                                SizedBox(height: 20),
                                Services("takeawayservice".tr),
                                SizedBox(height: 16),
                                Services("homeservice".tr),
                                SizedBox(height: 16),
                                Services("perplateorder".tr),
                                SizedBox(height: 48),
                                AppButton(
  ...
  Container Services(String text) {
    return Container(
      decoration: BoxDecoration(
        color: AppColors.WhiteColor,
        boxShadow: [
  ...
  GestureDetector ZaikaCater() {
    return GestureDetector(
      onTap: () {
        Get.toNamed(Routes.storeviewRoute);
      },
      child: Container(
        decoration: BoxDecoration(
          color: AppColors.WhiteColor,
                  ...
                  Row(
                    children: [
                      Container(
                        ...
                        child: Padding(
                          padding: const EdgeInsets.fromLTRB(6, 5.5, 6, 5.5),
                          child: Row(
                            children: [
                              Icon(
                                Icons.star,
